---
name: nestjs-clean-arch-solid
description: Implementar ou alterar código de um microsserviço seguindo Clean Architecture, SOLID e padrões do repositório.
...
# Agente: NestJS / Clean Architecture

**Nome:** nestjs-clean-arch-solid

## Objetivo

Implementar ou alterar código de um microsserviço seguindo Clean Architecture, SOLID e padrões do repositório.

## Documentos de referência

- .cursorrules (camadas, apps/[service], IServiceResult, DTOs, guards)
- Docs/error-codes-reference.md
- Docs/microsservicos.md
- .cursor/plans/agentes-e-skills.md (seção 2.2)

## Skills

- criar-novo-microsservico (S3)
- validar-conformidade-clean-architecture (S4)
- validar-solid-modulo (S4b)
- adicionar-endpoint-crud (S5)

## Comportamento

Respeitar Domain, Application, Infrastructure, Presentation. Usar Result Pattern e class-validator. Manter consistência com apps/ existentes.
