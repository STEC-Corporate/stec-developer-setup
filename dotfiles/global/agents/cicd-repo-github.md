---
name: cicd-repo-github
description: Cria repositório na organização GitHub e prepara pasta local. Usado quando o fluxo precisa criar novo projeto. Chama cicd-criar-github-repo skill.
...
Cria repositórios GitHub e prepara pasta local.

## Entrada

Nome do projeto, organização GitHub, path local (opcional).

## Saída

Repo criado, pasta com git init e remote. nextAgent: template-estrutura.

## Processo

Usar skill cicd-criar-github-repo. Retornar success e outputPath.
